...
namespace ModelValidationsExample.CustomModelBinders
{
    public class PersonModelBinder : IModelBinder
    {
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            // ricevuta la request e route selezionata, il model binding viene eseguito
            // e il model object restituito a seguito della task completata con successo, sarà
            // passato come parametro al:
            // IActionResult Index([FromBody] [ModelBinder(BinderType = typeof (PersonModelBinder))]Person person)

...
namespace IEquatableExample
{
    internal class Program
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine("Contains: " + customersList.Contains(another_cust));
            ...
            Console.WriteLine(customersList[2].CustomerID + ", " + customersList[2].CustomerName + ", " + customersList[2].Email + ", " + customersList[2].CustomerType);
